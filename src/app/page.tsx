...
export default function Home() {
  return (
    <Box title='Welcome to Stasg-Utils application.'>
      <div className='flex flex-col lg:flex-row justify-center items-center min-h-[70vh]'>
        <video
          src='/videos/SG.MP4'
          width={250}
          height={400}
          className='lg:w-[300px] lg:h-[300px] rounded-full'
          autoPlay
          muted
          loop
        />
        <div className='py-10 px-2 lg:px-8 text-center'>
